...
`,Vs=zs,se=d(class{constructor(e){this._form=e,this._db=new ti(this),this._mapper=new ie(this)}get form(){return this._form}get data(){return this._db}get mapper(){return this._mapper}static get sharedStyles(){return this._sheet||(this._sheet=new CSSStyleSheet,this._sheet.replaceSync(Vs)),this._sheet}},"X");p(se,"Context"),S(se,"_sheet");xt=se,Bs="Invalid binding value",re=d(class extends J{constructor(){super(...arguments);S(this,"_disabled",!1),S(this,"_clicked",0),S(this,"_context",null)}get context(){return this._context}static get properties(){return{name:{type:String,attribute:!0},bind:{type:String},type:{type:String,attribute:!0},hidden:{type:Boolean},disabled:{type:Boolean},required:{type:Boolean},focus:{type:Boolean},label:{type:String},tooltip:{type:String},placeholder:{type:String},valid:{type:Boolean},value:{type:Object},prefix:{type:Object},classes:{type:Array},autocomplete:{type:Object}}}get valid(){return this.checkValidity()}static get styles(){return[xt.sharedStyles,ee.sharedStyles]}closestElement(e,t=this,i=(s,r=s&&s.closest(e))=>!s||s===document||s===window?null:r||i(s.getRootNode().host)){return i(t)}connectedCallback(){var e,t,i;super.connectedCallback(),this.form=this.closest("xo-form"),(e=this.form)==null||e.registerElement(this),this.acceptMappedState(),(t=this.nestedElement)==null||t.addEventListener("focus",this.onfocus.bind(this)),(i=this.nestedElement)==null||i.addEventListener("blur",this.onblur.bind(this)),this.shadowRoot.addEventListener("input",this.onInput.bind(this)),this.shadowRoot.addEventListener("change",this.onInput.bind(this))}disconnectedCallback(){var e,t;(e=this.nestedElement)==null||e.removeEventListener("focus",this.onfocus),(t=this.nestedElement)==null||t.removeEventListener("blur",this.onblur),this.shadowRoot.removeEventListener("input",this.onInput),this.shadowRoot.removeEventListener("change",this.onInput)}firstUpdated(){this.autocomplete&&this.autocomplete.items&&this.nestedElement instanceof HTMLInputElement&&this.tryApplyAutoComplete()}set autocomplete(e){this._autocomplete=e}get autocomplete(){return this._autocomplete}tryApplyAutoComplete(){this._autoCompleter=new ee(this,this.nestedElement,this.autocomplete),this._autoCompleter.attach()}acceptMappedState(){}onfocus(e){e.stopPropagation(),this.focus=!0}onInput(e){e.preventDefault(),e.stopPropagation(),e.stopImmediatePropagation();let t=e.composedPath()[0];this.form.emit("interaction",{type:"input",control:this,source:t,value:this.value})}click(e){e.preventDefault(),e.stopImmediatePropagation(),e.stopPropagation();let t=e.composedPath()[0];this._clicked++,this.form&&this.form.emit("interaction",{type:"click",control:this,source:t,value:t.defaultValue||this._clicked})}checkValidity(){return this.nestedElement&&this.nestedElement.checkValidity?this.nestedElement.checkValidity():!0}reportValidity(){return this.nestedElement?this.nestedElement.reportValidity():!0}onblur(e){e.stopPropagation(),this.focus=!1}fireChange(){this.dispatchEvent(new Event("change",{bubbles:!0,cancelable:!1}))}get value(){var e;return(e=this.nestedElement)==null?void 0:e.value}set value(e){if(this.nestedElement)if(this.nestedElement instanceof HTMLSelectElement){let t=this.items.findIndex(i=>e===i.value||i);this.nestedElement.selectedIndex=t}else this.nestedElement.value=e??""}createControl(e,t,i,s={}){var r;if(!e||!e.data)throw Error("Invalid or missing context");t=this.transform(t,i)||"text";let o;if(customElements.get("xo-"+t)&&(t="xo-"+t),t.startsWith("xo-"))o=document.createElement(t);else{try{o=document.createElement(t);let l=(r=o.__proto__)==null?void 0:r.constructor.name;if(["HTMLUnknownElement","HTMLTimeElement"].includes(l))throw new Error("Invalid Element type")}catch{if(t.indexOf("-")===-1){o=document.createElement("input");try{o.type=t}catch{}}}let n=document.createElement("xo-control");n.type=t,n.nestedElement=o,o=n}return o&&(o.parent=this,o.options=s,e.parent=this,o._context=e,e.mapper.mapProperties(o,i)),o}transform(e,t){switch(e){}return e}getContainerClasses(){var e,t;let i=[];this.hidden&&i.push("xo-hd"),this.focus&&i.push("xo-fc"),this.disabled&&i.push("xo-ds"),this.valid||i.push("xo-iv"),this.classes&&i.push(...this.classes),this.nestedElement&&(this.nestedElement.value&&i.push("xo-ne"),this.isTextual&&i.push("xo-tx"));let s=(t=(e=this.form)==null?void 0:e.theme)!=null?t:"standard";return i.push(s),i.join(" ")}get isTextual(){return this.nestedElement instanceof HTMLTextAreaElement||this.nestedElement instanceof HTMLInputElement&&["text","url","tel","password","email"].includes(this.nestedElement.getAttribute("type"))}render(){return this.type&&this.setAttribute("data-type",this.type),this.closest("xo-nav")?w`${this.renderInput()}`:this.nestedElement instanceof HTMLButtonElement?(typeof this.nestedElement.defaultValue=="undefined"&&(this.nestedElement.defaultValue=this.nestedElement.value),this.nestedElement.removeEventListener("click",this.click),this.nestedElement.addEventListener("click",this.click.bind(this)),w`${this.renderInput(!0)}`):w`<div
    ...
    >
      ...
      >`}set disabled(e){this._disabled=e}get disabled(){return this._disabled}toString(){return this.nestedElement?this.nestedElement.nodeName==="INPUT"?`${this.nestedElement.nodeName}[type="${this.nestedElement.type}"]`:this.nestedElement.nodeName:this.nodeName}set invalidMessage(e){this._invalidMessage=e}get invalidMessage(){return this._invalidMessage}},"tt");p(re,"Control");window.customElements.define("xo-control",re);ut=re,ei=d(class{constructor(e){this.form=e,this.form.addEventListener("interaction",t=>{let i=t.detail.control;this.processValidation(i),this.checkValid()}),setTimeout(()=>{this.checkValid()},60)}checkValid(){let e=this.isPageValid(this.form.page),t=this.form.context.data.get("#/_xo/nav/total");this.form.context.data.set("#/_xo/disabled/next",!e||this.form.page>=t),this.form.context.data.set("#/_xo/disabled/back",this.form.page<=1)}processValidation(e){let t=e.checkValidity(),i=e.closestElement("xo-control");try{i.invalidMessage=e.validationMessage}catch{}i&&i.reportValidity&&i.reportValidity()}isPageValid(e){let t=this.form.childNodes[e-1];if(t){let i=t==null?void 0:t.childNodes,s=i.length,r=0;return i.forEach(o=>{o.checkValidity(),o.valid&&r++}),r===s}}},"kt");p(ei,"Validation");ii=ei,qs={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},Ws=p(e=>(...t)=>({_$litDirective$:e,values:t}),"e"),si=d(class{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,i){this._$Ct=e,this._$AM=t,this._$Ci=i}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}},"it");p(si,"i");Gs=p(e=>e===null||typeof e!="object"&&typeof e!="function","t"),Fs=p(e=>e.strings===void 0,"r"),pt=p((e,t)=>{var i,s;let r=e._$AN;if(r===void 0)return!1;for(let o of r)(s=(i=o)._$AO)===null||s===void 0||s.call(i,t,!1),pt(o,t);return!0},"e"),yt=p(e=>{let t,i;do{if((t=e._$AM)===void 0)break;i=t._$AN,i.delete(e),e=t}while((i==null?void 0:i.size)===0)},"o"),ri=p(e=>{for(let t;t=e._$AM;e=t){let i=t._$AN;if(i===void 0)t._$AN=i=new Set;else if(i.has(e))break;i.add(e),Ks(t)}},"n");d(oi,"ke");p(oi,"r");d(ni,"Te");p(ni,"h");Ks=p(e=>{var t,i,s,r;e.type==qs.CHILD&&((t=(s=e)._$AP)!==null&&t!==void 0||(s._$AP=ni),(i=(r=e)._$AQ)!==null&&i!==void 0||(r._$AQ=oi))},"l"),ai=d(class extends si{constructor(){super(...arguments),this._$AN=void 0}_$AT(e,t,i){super._$AT(e,t,i),ri(this),this.isConnected=e._$AU}_$AO(e,t=!0){var i,s;e!==this.isConnected&&(this.isConnected=e,e?(i=this.reconnected)===null||i===void 0||i.call(this):(s=this.disconnected)===null||s===void 0||s.call(this)),t&&(pt(this,e),yt(this))}setValue(e){if(Fs(this._$Ct))this._$Ct._$AI(e,this);else{let t=[...this._$Ct._$AH];t[this._$Ci]=e,this._$Ct._$AI(t,this,0)}}disconnected(){}reconnected(){}},"rt");p(ai,"d");li=d(class{constructor(e){this.U=e}disconnect(){this.U=void 0}reconnect(e){this.U=e}deref(){return this.U}},"ot");p(li,"s");hi=d(class{constructor(){this.Y=void 0,this.q=void 0}get(){return this.Y}pause(){var e;(e=this.Y)!==null&&e!==void 0||(this.Y=new Promise(t=>this.q=t))}resume(){var e;(e=this.q)===null||e===void 0||e.call(this),this.Y=this.q=void 0}},"nt");p(hi,"i");di=p(e=>!Gs(e)&&typeof e.then=="function","n"),ci=d(class extends ai{constructor(){super(...arguments),this._$Cwt=1073741823,this._$Cyt=[],this._$CG=new li(this),this._$CK=new hi}render(...e){var t;return(t=e.find(i=>!di(i)))!==null&&t!==void 0?t:O}update(e,t){let i=this._$Cyt,s=i.length;this._$Cyt=t;let r=this._$CG,o=this._$CK;this.isConnected||this.disconnected();for(let n=0;n<t.length&&!(n>this._$Cwt);n++){let l=t[n];if(!di(l))return this._$Cwt=n,l;n<s&&l===i[n]||(this._$Cwt=1073741823,s=0,Promise.resolve(l).then(async a=>{for(;o.get();)await o.get();let h=r.deref();if(h!==void 0){let m=h._$Cyt.indexOf(l);m>-1&&m<h._$Cwt&&(h._$Cwt=m,h.setValue(a))}}))}return O}disconnected(){this._$CG.disconnect(),this._$CK.pause()}reconnected(){this._$CG.reconnect(this),this._$CK.resume()}},"Pt");p(ci,"h");Zs=Ws(ci),Ys="1.0.9",oe=d(class extends ut{constructor(){super();S(this,"elements",{}),this._url=new URL(document.location.href),this._context=new xt(this),this._page=1}static get version(){return Ys}static get properties(){return Se(qt({},ut.properties),{page:{type:Number,attribute:!0},schema:{type:Object},src:{type:String,attribute:!0},theme:{type:String,attribute:!0}})}get context(){return this._context}set page(e){e!==this._page&&(e<1||e>this.querySelectorAll("xo-page").length||(e>this._page&&this.validation.isPageValid(this._page),this._page=e))}get page(){return this._page}set schema(e){this._schema=e,this.requestUpdate()}get schema(){return this._schema}registerElement(e){e.name&&(this.elements[e.name]=e)}set src(e){this._src=e}get src(){return this._src}readSchema(){return Te(this,null,function*(){if(!this.schema&&this.src)try{let e=yield import(this.src),t=Object.keys(e)[0];this._schema=e[t]}catch{throw Error("Could not load schema from "+this.src)}return this.schema?(this.interpretSchema(this.schema),!0):!1})}interpretSchema(e){if(typeof e!="object")throw Error("Invalid schema");e.page="#/_xo/nav/page",this.context.data.initialize(e.model,{pageCount:e.pages.length});let t=1;for(let i of e.pages){i.index=t++;let s=this.createControl(this.context,"xo-page",i);s.setAttribute("slot","w"),this.appendChild(s)}this.nav=this.createControl(this.context,"xo-nav",e),this.nav.controls=this.nav.controls,this.nav.setAttribute("slot","n"),this.appendChild(this.nav)}render(){return w`
      ${Zs(this.readSchema().then(e=>e?w`<div class="xo-c" data-page="${this.page}" >
            ...
            <div>`:w``),w`Loading...`)}
    `}firstUpdated(){this.validation=new ii(this),this.checkUrlState(),this.emit("first-updated")}emit(e,t={}){this.dispatchEvent(new CustomEvent(e,{detail:t}))}get url(){return this._url}checkUrlState(){}getSlotted(e){var t;let i=(t=e.shadowRoot)==null?void 0:t.querySelector("slot");return[...(i==null?void 0:i.assignedElements({flatten:!0}))||[]]}},"at");p(oe,"Form");Js=oe;window.customElements.define("xo-form",oe);ne=d(class extends ut{static get properties(){return{layout:{type:String,attribute:!0},align:{type:String,attribute:!0},ui:{type:String,attribute:!0},fields:{type:Array}}}renderInput(){return w`<div class="${this.getGroupClasses()}">
      <slot></slot>
    </div>`}set fields(e){this._fields=e;for(let t of this._fields){let i=this.createControl(this.context,t.type,t);this.appendChild(i)}}get fields(){return this._fields}getGroupClasses(){var e,t;return`xo-grp ${((e=this.layout)==null?void 0:e.startsWith("hor"))?"hor":"ver"} ${(t=this.align)!=null?t:""}`}getContainerClasses(){return`${super.getContainerClasses()} xo-gc ${this.ui?"type-"+this.ui:""}`}},"lt");p(ne,"Group");$t=ne;window.customElements.define("xo-group",ne);ae=d(class extends $t{constructor(){super(...arguments);this.hidden=!0}connectedCallback(){super.connectedCallback(),this.closest("xo-form").addEventListener("page",e=>{this.hidden=e.target.page!==this.index}),this.hidden=this.index!==1}render(){return this.hidden?w``:w`<fieldset
      ${this.hidden?"hidden":""}
    ...
    >
      ...
      <slot></slot>
    </fieldset>`}static get properties(){return{index:{type:Number,attribute:!0}}}},"ct");p(ae,"Page");window.customElements.define("xo-page",ae);Qs=ae,le=d(class extends $t{static get properties(){return{items:{type:Array},layout:{type:String},fields:{type:Array}}}set fields(e){if(!Array.isArray(e))throw Error("Invalid fields property value for repeat.");this._fields=e,this.refresh()}get fields(){return this._fields}set items(e){this._items=e,this.hasUpdated&&(this.refresh(),this.requestUpdate())}get items(){return this._items}refresh(){this.innerHTML="";let e=0;this.items.forEach(t=>{let i=this.createControl(this.context,"group",{fields:this.fields,classes:["xo-ri"],index:e},{scope:t,index:e++});i.setAttribute("data-index",e),this.appendChild(i)})}getContainerClasses(){return super.getContainerClasses()+" xo-rep"}},"dt");p(le,"Repeat");Xs=le;window.customElements.define("xo-repeat",le);he=d(class extends $t{static get styles(){return[xt.sharedStyles,Kt`
        :host {
          display: flex;
        }
        .xo-grp {
      ...
      `]}beforeMap(){this.layout="horizontal",this._controls=[],this.context.data.get("#/_xo/nav/total")>1&&this._controls.push({type:"button",name:"prev",label:"Back",bind:"#/_xo/nav/back",disabled:"#/_xo/disabled/back",click:this.prev.bind(this)},{type:"button",name:"nxt",label:"Next",bind:"#/_xo/nav/next",disabled:"#/_xo/disabled/next",click:this.next.bind(this)})}static get properties(){return{page:{type:Number},controls:{type:Array}}}set page(e){if(typeof e!="number")throw Error("Invalid value for page");let t=this.context.form.page;this.context.form.page=e,this.context.form.emit("page",{from:t,to:e}),this.updateUrl()}updateUrl(){}get page(){return this.context.form.page}set controls(e){if(!Array.isArray(e))throw Error("Invalid controls property value");this._controls=e;for(let t of this._controls){let i=this.createControl(this.context,"button",t);this.appendChild(i)}}get controls(){return this._controls}prev(){this.updateState(-1)}next(){this.updateState(1)}updateState(e){let t=this.context.data.get("#/_xo/nav/page"),i=this.context.data.get("#/_xo/nav/total");e>0?t=Math.min(i,t+1):t=Math.max(1,t-1),this.context.data.set("#/_xo/nav/page",t),this.context.data.set("#/_xo/disabled/next",t>=i),this.context.data.set("#/_xo/disabled/back",t<=1)}submit(){let e=this.closest("xo-form"),t={};Object.entries(e.elements).forEach(i=>{let s=i[0];if(s){let r=i[1].value;t[s]=r}}),console.log(JSON.stringify(t,null,2))}},"ht");p(he,"Navigation");window.customElements.define("xo-nav",he);tr=he,ui=d(class{static get Context(){return xt}static get Control(){return ut}static get DataBinding(){return ti}static get Form(){return Js}static get Group(){return $t}static get PropertyMapper(){return ie}static get Page(){return Qs}static get Repeat(){return Xs}static get Util(){return ct}static get Navigation(){return tr}static get Validation(){return ii}static get AutoComplete(){return ee}},"It");p(ui,"xo");pi=ui;});var _t,ce,mi,mt,gi,E,ue,At,pe=f(()=>{_t=window.ShadowRoot&&(window.ShadyCSS===void 0||window.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,ce=Symbol(),mi=new Map,mt=class{constructor(t,i){if(this._$cssResult$=!0,i!==ce)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=t}get styleSheet(){let t=mi.get(this.cssText);return _t&&t===void 0&&(mi.set(this.cssText,t=new CSSStyleSheet),t.replaceSync(this.cssText)),t}toString(){return this.cssText}};d(mt,"s");gi=d(e=>new mt(typeof e=="string"?e:e+"",ce),"o"),E=d((e,...t)=>{let i=e.length===1?e[0]:t.reduce((s,r,o)=>s+(n=>{if(n._$cssResult$===!0)return n.cssText;if(typeof n=="number")return n;throw Error("Value passed to 'css' function must be a 'css' function result: "+n+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(r)+e[o+1],e[0]);return new mt(i,ce)},"r"),ue=d((e,t)=>{_t?e.adoptedStyleSheets=t.map(i=>i instanceof CSSStyleSheet?i:i.styleSheet):t.forEach(i=>{let s=document.createElement("style"),r=window.litNonce;r!==void 0&&s.setAttribute("nonce",r),s.textContent=i.cssText,e.appendChild(s)})},"i"),At=_t?e=>e:e=>e instanceof CSSStyleSheet?(t=>{let i="";for(let s of t.cssRules)i+=s.cssText;return gi(i)})(e):e});var me,vi,er,fi,ge,bi,ve,P,Et=f(()=>{pe();pe();vi=window.trustedTypes,er=vi?vi.emptyScript:"",fi=window.reactiveElementPolyfillSupport,ge={toAttribute(e,t){switch(t){case Boolean:e=e?er:null;break;case Object:case Array:e=e==null?e:JSON.stringify(e)}return e},fromAttribute(e,t){let i=e;switch(t){case Boolean:i=e!==null;break;case Number:i=e===null?null:Number(e);break;case Object:case Array:try{i=JSON.parse(e)}catch{i=null}}return i}},bi=d((e,t)=>t!==e&&(t==t||e==e),"n"),ve={attribute:!0,type:String,converter:ge,reflect:!1,hasChanged:bi},P=class extends HTMLElement{constructor(){super(),this._$Et=new Map,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Ei=null,this.o()}static addInitializer(t){var i;(i=this.l)!==null&&i!==void 0||(this.l=[]),this.l.push(t)}static get observedAttributes(){this.finalize();let t=[];return this.elementProperties.forEach((i,s)=>{let r=this._$Eh(s,i);r!==void 0&&(this._$Eu.set(r,s),t.push(r))}),t}static createProperty(t,i=ve){if(i.state&&(i.attribute=!1),this.finalize(),this.elementProperties.set(t,i),!i.noAccessor&&!this.prototype.hasOwnProperty(t)){let s=typeof t=="symbol"?Symbol():"__"+t,r=this.getPropertyDescriptor(t,s,i);r!==void 0&&Object.defineProperty(this.prototype,t,r)}}static getPropertyDescriptor(t,i,s){return{get(){return this[i]},set(r){let o=this[t];this[i]=r,this.requestUpdate(t,o,s)},configurable:!0,enumerable:!0}}static getPropertyOptions(t){return this.elementProperties.get(t)||ve}static finalize(){if(this.hasOwnProperty("finalized"))return!1;this.finalized=!0;let t=Object.getPrototypeOf(this);if(t.finalize(),this.elementProperties=new Map(t.elementProperties),this._$Eu=new Map,this.hasOwnProperty("properties")){let i=this.properties,s=[...Object.getOwnPropertyNames(i),...Object.getOwnPropertySymbols(i)];for(let r of s)this.createProperty(r,i[r])}return this.elementStyles=this.finalizeStyles(this.styles),!0}static finalizeStyles(t){let i=[];if(Array.isArray(t)){let s=new Set(t.flat(1/0).reverse());for(let r of s)i.unshift(At(r))}else t!==void 0&&i.push(At(t));return i}static _$Eh(t,i){let s=i.attribute;return s===!1?void 0:typeof s=="string"?s:typeof t=="string"?t.toLowerCase():void 0}o(){var t;this._$Ep=new Promise(i=>this.enableUpdating=i),this._$AL=new Map,this._$Em(),this.requestUpdate(),(t=this.constructor.l)===null||t===void 0||t.forEach(i=>i(this))}addController(t){var i,s;((i=this._$Eg)!==null&&i!==void 0?i:this._$Eg=[]).push(t),this.renderRoot!==void 0&&this.isConnected&&((s=t.hostConnected)===null||s===void 0||s.call(t))}removeController(t){var i;(i=this._$Eg)===null||i===void 0||i.splice(this._$Eg.indexOf(t)>>>0,1)}_$Em(){this.constructor.elementProperties.forEach((t,i)=>{this.hasOwnProperty(i)&&(this._$Et.set(i,this[i]),delete this[i])})}createRenderRoot(){var t;let i=(t=this.shadowRoot)!==null&&t!==void 0?t:this.attachShadow(this.constructor.shadowRootOptions);return ue(i,this.constructor.elementStyles),i}connectedCallback(){var t;this.renderRoot===void 0&&(this.renderRoot=this.createRenderRoot()),this.enableUpdating(!0),(t=this._$Eg)===null||t===void 0||t.forEach(i=>{var s;return(s=i.hostConnected)===null||s===void 0?void 0:s.call(i)})}enableUpdating(t){}disconnectedCallback(){var t;(t=this._$Eg)===null||t===void 0||t.forEach(i=>{var s;return(s=i.hostDisconnected)===null||s===void 0?void 0:s.call(i)})}attributeChangedCallback(t,i,s){this._$AK(t,s)}_$ES(t,i,s=ve){var r,o;let n=this.constructor._$Eh(t,s);if(n!==void 0&&s.reflect===!0){let l=((o=(r=s.converter)===null||r===void 0?void 0:r.toAttribute)!==null&&o!==void 0?o:ge.toAttribute)(i,s.type);this._$Ei=t,l==null?this.removeAttribute(n):this.setAttribute(n,l),this._$Ei=null}}_$AK(t,i){var s,r,o;let n=this.constructor,l=n._$Eu.get(t);if(l!==void 0&&this._$Ei!==l){let a=n.getPropertyOptions(l),h=a.converter,m=(o=(r=(s=h)===null||s===void 0?void 0:s.fromAttribute)!==null&&r!==void 0?r:typeof h=="function"?h:null)!==null&&o!==void 0?o:ge.fromAttribute;this._$Ei=l,this[l]=m(i,a.type),this._$Ei=null}}requestUpdate(t,i,s){let r=!0;t!==void 0&&(((s=s||this.constructor.getPropertyOptions(t)).hasChanged||bi)(this[t],i)?(this._$AL.has(t)||this._$AL.set(t,i),s.reflect===!0&&this._$Ei!==t&&(this._$EC===void 0&&(this._$EC=new Map),this._$EC.set(t,s))):r=!1),!this.isUpdatePending&&r&&(this._$Ep=this._$E_())}async _$E_(){this.isUpdatePending=!0;try{await this._$Ep}catch(i){Promise.reject(i)}let t=this.scheduleUpdate();return t!=null&&await t,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){var t;if(!this.isUpdatePending)return;this.hasUpdated,this._$Et&&(this._$Et.forEach((r,o)=>this[o]=r),this._$Et=void 0);let i=!1,s=this._$AL;try{i=this.shouldUpdate(s),i?(this.willUpdate(s),(t=this._$Eg)===null||t===void 0||t.forEach(r=>{var o;return(o=r.hostUpdate)===null||o===void 0?void 0:o.call(r)}),this.update(s)):this._$EU()}catch(r){throw i=!1,this._$EU(),r}i&&this._$AE(s)}willUpdate(t){}_$AE(t){var i;(i=this._$Eg)===null||i===void 0||i.forEach(s=>{var r;return(r=s.hostUpdated)===null||r===void 0?void 0:r.call(s)}),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(t)),this.updated(t)}_$EU(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$Ep}shouldUpdate(t){return!0}update(t){this._$EC!==void 0&&(this._$EC.forEach((i,s)=>this._$ES(s,this[s],i)),this._$EC=void 0),this._$EU()}updated(t){}firstUpdated(t){}};d(P,"a");P.finalized=!0,P.elementProperties=new Map,P.elementStyles=[],P.shadowRootOptions={mode:"open"},fi==null||fi({ReactiveElement:P}),((me=globalThis.reactiveElementVersions)!==null&&me!==void 0?me:globalThis.reactiveElementVersions=[]).push("1.3.1")});function W(e,t,i=e,s){var r,o,n,l;if(t===I)return t;let a=s!==void 0?(r=i._$Cl)===null||r===void 0?void 0:r[s]:i._$Cu,h=vt(t)?void 0:t._$litDirective$;return(a==null?void 0:a.constructor)!==h&&((o=a==null?void 0:a._$AO)===null||o===void 0||o.call(a,!1),h===void 0?a=void 0:(a=new h(e),a._$AT(e,i,s)),s!==void 0?((n=(l=i)._$Cl)!==null&&n!==void 0?n:l._$Cl=[])[s]=a:i._$Cu=a),a!==void 0&&(t=W(e,a._$AS(e,t.values),a,s)),t}var fe,X,xi,U,be,ir,tt,gt,vt,yi,$i,ft,_i,Ai,B,Ei,wi,Ci,ki,y,gr,I,$,Si,Ti,et,Pi,q,wt,L,G,Ct,sr,kt,St,Tt,Ui,Ii,F=f(()=>{X=globalThis.trustedTypes,xi=X?X.createPolicy("lit-html",{createHTML:e=>e}):void 0,U=`lit$${(Math.random()+"").slice(9)}$`,be="?"+U,ir=`<${be}>`,tt=document,gt=d((e="")=>tt.createComment(e),"h"),vt=d(e=>e===null||typeof e!="object"&&typeof e!="function","r"),yi=Array.isArray,$i=d(e=>{var t;return yi(e)||typeof((t=e)===null||t===void 0?void 0:t[Symbol.iterator])=="function"},"u"),ft=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,_i=/-->/g,Ai=/>/g,B=/>|[ 	\n\r](?:([^\s"'>=/]+)([ 	\n\r]*=[ 	\n\r]*(?:[^ 	\n\r"'`<>=]|("|')|))|$)/g,Ei=/'/g,wi=/"/g,Ci=/^(?:script|style|textarea|title)$/i,ki=d(e=>(t,...i)=>({_$litType$:e,strings:t,values:i}),"p"),y=ki(1),gr=ki(2),I=Symbol.for("lit-noChange"),$=Symbol.for("lit-nothing"),Si=new WeakMap,Ti=d((e,t,i)=>{var s,r;let o=(s=i==null?void 0:i.renderBefore)!==null&&s!==void 0?s:t,n=o._$litPart$;if(n===void 0){let l=(r=i==null?void 0:i.renderBefore)!==null&&r!==void 0?r:null;o._$litPart$=n=new L(t.insertBefore(gt(),l),l,void 0,i??{})}return n._$AI(e),n},"x"),et=tt.createTreeWalker(tt,129,null,!1),Pi=d((e,t)=>{let i=e.length-1,s=[],r,o=t===2?"<svg>":"",n=ft;for(let a=0;a<i;a++){let h=e[a],m,c,u=-1,g=0;for(;g<h.length&&(n.lastIndex=g,c=n.exec(h),c!==null);)g=n.lastIndex,n===ft?c[1]==="!--"?n=_i:c[1]!==void 0?n=Ai:c[2]!==void 0?(Ci.test(c[2])&&(r=RegExp("</"+c[2],"g")),n=B):c[3]!==void 0&&(n=B):n===B?c[0]===">"?(n=r??ft,u=-1):c[1]===void 0?u=-2:(u=n.lastIndex-c[2].length,m=c[1],n=c[3]===void 0?B:c[3]==='"'?wi:Ei):n===wi||n===Ei?n=B:n===_i||n===Ai?n=ft:(n=B,r=void 0);let v=n===B&&e[a+1].startsWith("/>")?" ":"";o+=n===ft?h+ir:u>=0?(s.push(m),h.slice(0,u)+"$lit$"+h.slice(u)+U+v):h+U+(u===-2?(s.push(void 0),a):v)}let l=o+(e[i]||"<?>")+(t===2?"</svg>":"");if(!Array.isArray(e)||!e.hasOwnProperty("raw"))throw Error("invalid template strings array");return[xi!==void 0?xi.createHTML(l):l,s]},"C"),q=class{constructor({strings:t,_$litType$:i},s){let r;this.parts=[];let o=0,n=0,l=t.length-1,a=this.parts,[h,m]=Pi(t,i);if(this.el=q.createElement(h,s),et.currentNode=this.el.content,i===2){let c=this.el.content,u=c.firstChild;u.remove(),c.append(...u.childNodes)}for(;(r=et.nextNode())!==null&&a.length<l;){if(r.nodeType===1){if(r.hasAttributes()){let c=[];for(let u of r.getAttributeNames())if(u.endsWith("$lit$")||u.startsWith(U)){let g=m[n++];if(c.push(u),g!==void 0){let v=r.getAttribute(g.toLowerCase()+"$lit$").split(U),x=/([.?@])?(.*)/.exec(g);a.push({type:1,index:o,name:x[2],strings:v,ctor:x[1]==="."?Ct:x[1]==="?"?kt:x[1]==="@"?St:G})}else a.push({type:6,index:o})}for(let u of c)r.removeAttribute(u)}if(Ci.test(r.tagName)){let c=r.textContent.split(U),u=c.length-1;if(u>0){r.textContent=X?X.emptyScript:"";for(let g=0;g<u;g++)r.append(c[g],gt()),et.nextNode(),a.push({type:2,index:++o});r.append(c[u],gt())}}}else if(r.nodeType===8)if(r.data===be)a.push({type:2,index:o});else{let c=-1;for(;(c=r.data.indexOf(U,c+1))!==-1;)a.push({type:7,index:o}),c+=U.length-1}o++}}static createElement(t,i){let s=tt.createElement("template");return s.innerHTML=t,s}};d(q,"E");d(W,"P");wt=class{constructor(t,i){this.v=[],this._$AN=void 0,this._$AD=t,this._$AM=i}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}p(t){var i;let{el:{content:s},parts:r}=this._$AD,o=((i=t==null?void 0:t.creationScope)!==null&&i!==void 0?i:tt).importNode(s,!0);et.currentNode=o;let n=et.nextNode(),l=0,a=0,h=r[0];for(;h!==void 0;){if(l===h.index){let m;h.type===2?m=new L(n,n.nextSibling,this,t):h.type===1?m=new h.ctor(n,h.name,h.strings,this,t):h.type===6&&(m=new Tt(n,this,t)),this.v.push(m),h=r[++a]}l!==(h==null?void 0:h.index)&&(n=et.nextNode(),l++)}return o}m(t){let i=0;for(let s of this.v)s!==void 0&&(s.strings!==void 0?(s._$AI(t,s,i),i+=s.strings.length-2):s._$AI(t[i])),i++}};d(wt,"V");L=class{constructor(t,i,s,r){var o;this.type=2,this._$AH=$,this._$AN=void 0,this._$AA=t,this._$AB=i,this._$AM=s,this.options=r,this._$Cg=(o=r==null?void 0:r.isConnected)===null||o===void 0||o}get _$AU(){var t,i;return(i=(t=this._$AM)===null||t===void 0?void 0:t._$AU)!==null&&i!==void 0?i:this._$Cg}get parentNode(){let t=this._$AA.parentNode,i=this._$AM;return i!==void 0&&t.nodeType===11&&(t=i.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,i=this){t=W(this,t,i),vt(t)?t===$||t==null||t===""?(this._$AH!==$&&this._$AR(),this._$AH=$):t!==this._$AH&&t!==I&&this.$(t):t._$litType$!==void 0?this.T(t):t.nodeType!==void 0?this.k(t):$i(t)?this.S(t):this.$(t)}A(t,i=this._$AB){return this._$AA.parentNode.insertBefore(t,i)}k(t){this._$AH!==t&&(this._$AR(),this._$AH=this.A(t))}$(t){this._$AH!==$&&vt(this._$AH)?this._$AA.nextSibling.data=t:this.k(tt.createTextNode(t)),this._$AH=t}T(t){var i;let{values:s,_$litType$:r}=t,o=typeof r=="number"?this._$AC(t):(r.el===void 0&&(r.el=q.createElement(r.h,this.options)),r);if(((i=this._$AH)===null||i===void 0?void 0:i._$AD)===o)this._$AH.m(s);else{let n=new wt(o,this),l=n.p(this.options);n.m(s),this.k(l),this._$AH=n}}_$AC(t){let i=Si.get(t.strings);return i===void 0&&Si.set(t.strings,i=new q(t)),i}S(t){yi(this._$AH)||(this._$AH=[],this._$AR());let i=this._$AH,s,r=0;for(let o of t)r===i.length?i.push(s=new L(this.A(gt()),this.A(gt()),this,this.options)):s=i[r],s._$AI(o),r++;r<i.length&&(this._$AR(s&&s._$AB.nextSibling,r),i.length=r)}_$AR(t=this._$AA.nextSibling,i){var s;for((s=this._$AP)===null||s===void 0||s.call(this,!1,!0,i);t&&t!==this._$AB;){let r=t.nextSibling;t.remove(),t=r}}setConnected(t){var i;this._$AM===void 0&&(this._$Cg=t,(i=this._$AP)===null||i===void 0||i.call(this,t))}};d(L,"N");G=class{constructor(t,i,s,r,o){this.type=1,this._$AH=$,this._$AN=void 0,this.element=t,this.name=i,this._$AM=r,this.options=o,s.length>2||s[0]!==""||s[1]!==""?(this._$AH=Array(s.length-1).fill(new String),this.strings=s):this._$AH=$}get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}_$AI(t,i=this,s,r){let o=this.strings,n=!1;if(o===void 0)t=W(this,t,i,0),n=!vt(t)||t!==this._$AH&&t!==I,n&&(this._$AH=t);else{let l=t,a,h;for(t=o[0],a=0;a<o.length-1;a++)h=W(this,l[s+a],i,a),h===I&&(h=this._$AH[a]),n||(n=!vt(h)||h!==this._$AH[a]),h===$?t=$:t!==$&&(t+=(h??"")+o[a+1]),this._$AH[a]=h}n&&!r&&this.C(t)}C(t){t===$?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"")}};d(G,"S");Ct=class extends G{constructor(){super(...arguments),this.type=3}C(t){this.element[this.name]=t===$?void 0:t}};d(Ct,"M");sr=X?X.emptyScript:"",kt=class extends G{constructor(){super(...arguments),this.type=4}C(t){t&&t!==$?this.element.setAttribute(this.name,sr):this.element.removeAttribute(this.name)}};d(kt,"H");St=class extends G{constructor(t,i,s,r,o){super(t,i,s,r,o),this.type=5}_$AI(t,i=this){var s;if((t=(s=W(this,t,i,0))!==null&&s!==void 0?s:$)===I)return;let r=this._$AH,o=t===$&&r!==$||t.capture!==r.capture||t.once!==r.once||t.passive!==r.passive,n=t!==$&&(r===$||o);o&&this.element.removeEventListener(this.name,this,r),n&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){var i,s;typeof this._$AH=="function"?this._$AH.call((s=(i=this.options)===null||i===void 0?void 0:i.host)!==null&&s!==void 0?s:this.element,t):this._$AH.handleEvent(t)}};d(St,"I");Tt=class{constructor(t,i,s){this.element=t,this.type=6,this._$AN=void 0,this._$AM=i,this.options=s}get _$AU(){return this._$AM._$AU}_$AI(t){W(this,t)}};d(Tt,"L");Ui={P:"$lit$",L:U,V:be,I:1,N:Pi,R:wt,D:$i,j:W,H:L,O:G,F:kt,B:St,W:Ct,Z:Tt},Ii=window.litHtmlPolyfillSupport;Ii==null||Ii(q,L),((fe=globalThis.litHtmlVersions)!==null&&fe!==void 0?fe:globalThis.litHtmlVersions=[]).push("2.2.1")});var xe,ye,b,Hi,Oi=f(()=>{Et();Et();F();F();b=class extends P{constructor(){super(...arguments),this.renderOptions={host:this},this._$Dt=void 0}createRenderRoot(){var t,i;let s=super.createRenderRoot();return(t=(i=this.renderOptions).renderBefore)!==null&&t!==void 0||(i.renderBefore=s.firstChild),s}update(t){let i=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(t),this._$Dt=Ti(i,this.renderRoot,this.renderOptions)}connectedCallback(){var t;super.connectedCallback(),(t=this._$Dt)===null||t===void 0||t.setConnected(!0)}disconnectedCallback(){var t;super.disconnectedCallback(),(t=this._$Dt)===null||t===void 0||t.setConnected(!1)}render(){return I}};d(b,"s");b.finalized=!0,b._$litElement$=!0,(xe=globalThis.litElementHydrateSupport)===null||xe===void 0||xe.call(globalThis,{LitElement:b});Hi=globalThis.litElementPolyfillSupport;Hi==null||Hi({LitElement:b});((ye=globalThis.litElementVersions)!==null&&ye!==void 0?ye:globalThis.litElementVersions=[]).push("3.2.0")});var C=f(()=>{Et();F();Oi()});var $e,Mi=f(()=>{F();$e=d(e=>e??$,"l")});var Li=f(()=>{Mi()});var Ri,Ni,Pt,Di=f(()=>{Ri={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},Ni=d(e=>(...t)=>({_$litDirective$:e,values:t}),"e"),Pt=class{constructor(t){}get _$AU(){return this._$AM._$AU}_$AT(t,i,s){this._$Ct=t,this._$AM=i,this._$Ci=s}_$AS(t,i){return this.update(t,i)}update(t,i){return this.render(...i)}};d(Pt,"i")});var rr,ji,it,R,or,zi,Vi,Ut,Bi=f(()=>{F();({H:rr}=Ui),ji=d(()=>document.createComment(""),"e"),it=d((e,t,i)=>{var s;let r=e._$AA.parentNode,o=t===void 0?e._$AB:t._$AA;if(i===void 0){let n=r.insertBefore(ji(),o),l=r.insertBefore(ji(),o);i=new rr(n,l,e,e.options)}else{let n=i._$AB.nextSibling,l=i._$AM,a=l!==e;if(a){let h;(s=i._$AQ)===null||s===void 0||s.call(i,e),i._$AM=e,i._$AP!==void 0&&(h=e._$AU)!==l._$AU&&i._$AP(h)}if(n!==o||a){let h=i._$AA;for(;h!==n;){let m=h.nextSibling;r.insertBefore(h,o),h=m}}}return i},"u"),R=d((e,t,i=e)=>(e._$AI(t,i),e),"c"),or={},zi=d((e,t=or)=>e._$AH=t,"s"),Vi=d(e=>e._$AH,"a"),Ut=d(e=>{var t;(t=e._$AP)===null||t===void 0||t.call(e,!1,!0);let i=e._$AA,s=e._$AB.nextSibling;for(;i!==s;){let r=i.nextSibling;i.remove(),i=r}},"m")});var qi,N,Wi=f(()=>{F();Di();Bi();qi=d((e,t,i)=>{let s=new Map;for(let r=t;r<=i;r++)s.set(e[r],r);return s},"u"),N=Ni(class extends Pt{constructor(e){if(super(e),e.type!==Ri.CHILD)throw Error("repeat() can only be used in text expressions")}dt(e,t,i){let s;i===void 0?i=t:t!==void 0&&(s=t);let r=[],o=[],n=0;for(let l of e)r[n]=s?s(l,n):n,o[n]=i(l,n),n++;return{values:o,keys:r}}render(e,t,i){return this.dt(e,t,i).values}update(e,[t,i,s]){var r;let o=Vi(e),{values:n,keys:l}=this.dt(t,i,s);if(!Array.isArray(o))return this.ut=l,n;let a=(r=this.ut)!==null&&r!==void 0?r:this.ut=[],h=[],m,c,u=0,g=o.length-1,v=0,x=n.length-1;for(;u<=g&&v<=x;)if(o[u]===null)u++;else if(o[g]===null)g--;else if(a[u]===l[v])h[v]=R(o[u],n[v]),u++,v++;else if(a[g]===l[x])h[x]=R(o[g],n[x]),g--,x--;else if(a[u]===l[x])h[x]=R(o[u],n[x]),it(e,h[x+1],o[u]),u++,x--;else if(a[g]===l[v])h[v]=R(o[g],n[v]),it(e,o[u],o[g]),g--,v++;else if(m===void 0&&(m=qi(l,v,x),c=qi(a,u,g)),m.has(a[u]))if(m.has(a[g])){let k=c.get(l[v]),Vt=k!==void 0?o[k]:null;if(Vt===null){let we=it(e,o[u]);R(we,n[v]),h[v]=we}else h[v]=R(Vt,n[v]),it(e,o[u],Vt),o[k]=null;v++}else Ut(o[g]),g--;else Ut(o[u]),u++;for(;v<=x;){let k=it(e,h[x+1]);R(k,n[v]),h[v++]=k}for(;u<=g;){let k=o[u++];k!==null&&Ut(k)}return this.ut=l,zi(e,h),I}})});var bt=f(()=>{Wi()});var _e,D,Ae=f(()=>{C();Li();bt();_e=class extends b{constructor(){super();_(this,"_value",[]);_(this,"_layout","default");this.items=[]}static get styles(){return[E`
        .cards {
          width: 100%;
          flex-wrap: wrap;
          display: grid;
      ...
      `]}static get properties(){return{items:{type:Array},value:{type:Object},layout:{type:String},cardWidth:{type:String},cardHeight:{type:String}}}set layout(t){this._layout=t}get layout(){return this._layout}render(){return y`<div class="${this.layout}" style=${this.getStyle()}>
      ${N(this.items,t=>t.id,(t,i)=>(t=this.makeItem(t),t.checked=this.isSelected(t),t.style=this.getItemStyle(t),t.class=this.getItemClass(t),this.renderItem(t)))}
    </div>`}renderItem(t){return y`<label
      title=${t.label}
      class=${$e(t.class?t.class:void 0)}
  ...
  `),_(st,"properties",{modal:{type:Boolean},display:{type:Boolean}});customElements.define("xw-dialog",st);Ki=st});var nr,Mt,Yi,Ji=f(()=>{C();C();bt();nr="100px",Mt=class extends b{constructor(){super(...arguments);_(this,"_value",[]);_(this,"_max",-1);_(this,"_height",nr);_(this,"_types",["image/"])}static get styles(){return[E`
        .drop {
          position: relative;
      ...
      `]}static get properties(){return{value:{type:Object},height:{type:Number},max:{type:Number},types:{type:Array},infotext:{type:String}}}get height(){return this._height}set height(t){this._height=t}set max(t){this._max=t}get max(){return this._max}set value(t){typeof t!="undefined"&&(!Array.isArray(t)||(this._value=t))}get value(){return this._value}set types(t){if(!Array.isArray(t))throw Error("Types must be array");this._types=t}get types(){return this._types}render(){let t=this.infotext?`--filedrop-info-text: ${this.infotext}`:"",i=`--image-height: ${this.height};`+t;return y`<div
      style="${i}"
