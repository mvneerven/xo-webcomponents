...
exports.managePets = void 0;
const pet_breeds_json_1 = __importDefault(require("../data/pet-breeds.json"));
const breedAutocomplete = (options, e) => {
    ...
    let bd = breedData;
    if (type)
        bd = pet_breeds_json_1.default[type.toLowerCase()];
            ...
            "#/state/type": [
                {
                    set: "#/state/breeds",
                    value: (context) => {
                        window.breedData = pet_breeds_json_1.default[context.value.toLowerCase()];
                    },
                },
            ],
        },
                            ...
                            fields: [
                                ...
                                },
                                {
                                    ...
                                    click: (e) => {
                                        ...
                                        if (repeat) {
                                            const data = repeat.context.data, ar = data.get("#/state/pets");
...
//# sourceMappingURL=manage-pets.js.map