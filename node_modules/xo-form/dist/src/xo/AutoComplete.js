...
class AutoComplete {
    ...
    attach() {
        ...
        this.clear();
        (_a = this.control.shadowRoot
            .querySelector(".xo-cn")) === null || _a === void 0 ? void 0 : _a.setAttribute("data-autocomplete", "on");
    }
    moveResult(add) {
        this.show();
    ...
    selectResult(div) {
        ...
        if (div) {
            ...
            let options = Object.assign(Object.assign({}, result), { search: this.htmlElement.value });
    ...
    resultsHandler(r, options) {
        ...
        r.forEach((i) => {
            ...
            if (i.element) {
                ...
                this.resultsDiv.appendChild(Util_1.default.parseHTML(`<div title="${i.tooltip || ""}" data-index="${index}" class="${this.cssClasses.item}">
    ...
    formatResultItem(i, options, catHandler) {
        ...
        if (options.search) {
            ...
            i.description = (_a = i.description) === null || _a === void 0 ? void 0 : _a.replace("%search%", options.search);
        }
    ...
    getItems(options, e) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return new Promise((resolve) => {
                if (Util_1.default.isUrl(this.items)) {
    ...
    isMatch(options, i) {
        var _a, _b;
        if (((_a = i.text) === null || _a === void 0 ? void 0 : _a.indexOf("%search%")) >= 0)
            return true;
        return options.search
            ? ((_b = i.text) === null || _b === void 0 ? void 0 : _b.toLowerCase().indexOf(options.search.toLowerCase())) >= 0
            : options.suggest;
    }
}
